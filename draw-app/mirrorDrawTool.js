...
function mirrorDrawTool(){
	...
	this.draw = function(){
		...
		if(mouseIsPressed){
			...
			// if there are values in the previous locations draw a line between them and the current positions
			else{
